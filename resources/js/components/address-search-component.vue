      ...
      search(addressesSelected){
        ...
        $.ajax({
          ...
          success:function(inData,state){
            ...
            let numberOfRooms = self.realTimeRooms;
            let bedrooms = self.realTimeBedrooms;
            let radius = self.realTimeRadius;
            let services = self.selectedCheckboxes;
